...
app.post('/lutador/edt/:id', upload.sing('foto'), async (req, res) => {
...
app.post('/luta/add/ok', upload.single('foto'), async (req, res) => {
    await Lutacreate({
        nome:req.body.nome,
        catgpeso:req.body.catgpeso,
        nacionalidade: req.body.nacionalidade,
...
app.post('/luta/edt/:id', upload.single('foto'), async (req, res) => {
  await Lutacreate({
        nome:req.body.nome,
        catgpeso:req.body.catgpeso,
        nacionalidade: req.body.nacionalidade,
    ...
    res.render("luta/addok")
  await Luta.findByIdAndUpdate(req.params.id, req.body)
  res.render('luta/edtok');
});
